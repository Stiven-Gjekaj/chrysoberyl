...
- [x] **Phase 4: SVG rasterization** - Rasterize vector input on the CPU and prove the font and curve output is deterministic. (completed 2026-09-09)
...
- [x] 01-04-PLAN.md — Global registration on one arithmetic path, with subpixel refinement

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-05-PLAN.md — Refuse a pair the engine cannot register, on a threshold measured from a corpus

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 01-06-PLAN.md — Local registration: warp, summed-area table, block match and the residual field

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 01-07-PLAN.md — Classify: labelled regions, antialiasing suppression, change kind and colour

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 01-08-PLAN.md — Determinism guards, watched failing on purpose
...
- [x] 02-01-PLAN.md — The sequence becomes the only unit, and one numbered frame sequence pair compares end to end

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 02-02-PLAN.md — Guard the one comparison pipeline, commit phase 1's four digests, and hash a sequence
...
- [x] 02-04-PLAN.md — Drill the engine boundary check, then extend the six-runner matrix to the new fixtures
...
Wave 3 onward may not, and Wave 4 measures that over Wave 3's own commit
range after proving the measurement can fail.
...
- [x] 03-03-PLAN.md — The report names the file a frame came from, and every decode call site is guarded
...
- [x] 04-03-PLAN.md — Hash the SVG fixture on six runners, and settle or withdraw the determinism claim
...
| 4. SVG rasterization | 3/3 | Complete    | 2026-09-09 |
